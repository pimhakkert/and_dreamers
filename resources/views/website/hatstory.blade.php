        ...
        <div class="max-w-5xl m-auto">
            <div class="w-full">
                <div id="hatstory">
                    <div class="page-group">
                        <div class="hatstory-page">
                            <div class="hatstory-next group h-full flex flex-col items-center cover cursor-pointer">
                                ...
                                <img class="w-36 md:w-60 h-36 md:h-60 object-cover rounded-full border-brown md:border-2 mt-10" src="/storage/hatimage/{{ $hatStory->hat_image }}" alt="Image of this hat">
                    ...
                    <div class="page-group">
                        <div class="hatstory-page shadow-2xl bg-lightbrown py-7 pl-7" data-density="soft">
                        ...
                        <div class="hatstory-page shadow-2xl bg-lightbrown py-7 pr-7" data-density="soft">
                                ...
                                <div class="px-14 pb-12 z-10 h-full flex flex-col justify-end" style="border-right: 1px solid #888;">
                                    <form>
                                        <p class="text-brown text-xl">
                                            ...
                                            <select class="border-none bg-transparent pr-7 pl-0 p-2 text-lg" name="type" id="type">
                                        ...
                                        <div class="w-7/12 mt-5">
                                            ...
                                            <button type="button" class="border-4 border-brown leading-none text-brown w-full mt-5 p-2 lg:p-3 2xl:p-3 pb-1 lg:pb-2 2xl:pb-2 font-semibold hover:bg-brown hover:text-white">{{ __('pages/general.contact_button') }}</button>
                                        </div>
                                    </form>
